    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          >
            <div className="relative w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
              <svg className="w-5 h-5 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
            </div>
            <div>
              <span className="text-base sm:text-xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-blue-700 bg-clip-text text-transparent">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            >
              ...
              {/* Dropdown Menu */}
              {aboutDropdown && (
                <div className="absolute top-full left-0 mt-1 w-56 bg-white rounded-2xl shadow-2xl border border-gray-100 py-2 z-[200]">
                  {aboutLinks.map((link) => (
                    <Link
                      key={link.path}
                      to={link.path}
                    ...
                    >
                      <div className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all ${
                        ...
                        <svg className={`w-5 h-5 ${isActive(link.path) ? 'text-white' : 'text-gray-600 group-hover:text-white'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link 
              to="/login" 
              className="ml-2 px-5 py-2.5 rounded-xl font-semibold text-gray-600 hover:text-blue-600 hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50 transition-all duration-300 flex items-center space-x-2"
            >
            ...
            <Link 
              to="/membership" 
              className="ml-2 bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold hover:from-blue-700 hover:via-indigo-700 hover:to-indigo-800 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center space-x-2"
            >
              <span>Join Us</span>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
