        ...
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            >
              ...
              <div>
                <span className="text-base sm:text-xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-blue-700 bg-clip-text text-transparent group-hover:from-blue-600 group-hover:to-indigo-600 transition-all duration-300">
                  The Real Estate Club
                </span>
                <div className="text-xs sm:text-xs text-gray-500 font-medium group-hover:text-blue-600 transition-colors">Building Future Leaders</div>
              </div>
            </Link>
          </motion.div>
